...
## §3 — Neon-side / environment — 0 OPEN Neon-side (the multi-node range row CLOSED 2026-09-19), 3 PARKED, each on a compiler card (flow lowering `||`; `isAccessorTyped` alias/nullable; `<Index>` as a tag); `Index` does not grow CLOSED 2026-09-18; direct-emission style CLOSED 2026-09-17; `voidHost` CLOSED 2026-07-27 (late)
